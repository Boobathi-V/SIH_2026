...
class FundusPredictor:
    ...
    def predict(
        ...
        return {
            ...
            "dominant_lesion": lesion_res.get("dominant_lesion", "Retinal Pathology"),
            "dominant_contribution_pct": lesion_res.get("dominant_contribution_pct", 50),
            "dominant_reason": lesion_res.get("dominant_reason", ""),
            "attributions": lesion_res.get("attributions", []),
            "zoomed_crops": lesion_res.get("zoomed_crops", []),
